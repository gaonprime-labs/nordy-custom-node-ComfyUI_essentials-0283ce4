...
NODE_CLASS_MAPPINGS = {
    "GetImageSize+_legacy-Test": GetImageSize,

    "ImageResize+_legacy-Test": ImageResize,
    "ImageCrop+_legacy-Test": ImageCrop,
    "ImageFlip+_legacy-Test": ImageFlip,

    "ImageDesaturate+_legacy-Test": ImageDesaturate,
    "ImagePosterize+_legacy-Test": ImagePosterize,
    "ImageCASharpening+_legacy-Test": ImageCAS,
    "ImageSeamCarving+_legacy-Test": ImageSeamCarving,
    "ImageEnhanceDifference+_legacy-Test": ImageEnhanceDifference,
    "ImageExpandBatch+_legacy-Test": ImageExpandBatch,
    "ImageFromBatch+_legacy-Test": ImageFromBatch,
    "ImageCompositeFromMaskBatch+_legacy-Test": ImageCompositeFromMaskBatch,
    "ExtractKeyframes+_legacy-Test": ExtractKeyframes,
    "ImageApplyLUT+_legacy-Test": ImageApplyLUT,

    "MaskBlur+_legacy-Test": MaskBlur,
    "MaskFlip+_legacy-Test": MaskFlip,
    "MaskPreview+_legacy-Test": MaskPreview,
    "MaskBatch+_legacy-Test": MaskBatch,
    "MaskExpandBatch+_legacy-Test": MaskExpandBatch,
    "TransitionMask+_legacy-Test": TransitionMask,
    "MaskFromColor+_legacy-Test": MaskFromColor,
    "MaskFromBatch+_legacy-Test": MaskFromBatch,

    "SimpleMath+_legacy-Test": SimpleMath,
    "ConsoleDebug+_legacy-Test": ConsoleDebug,
    "DebugTensorShape+_legacy-Test": DebugTensorShape,

    "ModelCompile+_legacy-Test": ModelCompile,
    "BatchCount+_legacy-Test": BatchCount,

    "KSamplerVariationsStochastic+_legacy-Test": KSamplerVariationsStochastic,
    "KSamplerVariationsWithNoise+_legacy-Test": KSamplerVariationsWithNoise,
    "CLIPTextEncodeSDXL+_legacy-Test": CLIPTextEncodeSDXLSimplified,
    "SDXLEmptyLatentSizePicker+_legacy-Test": SDXLEmptyLatentSizePicker,

    "DrawText+_legacy-Test": DrawText,
    "RemBGSession+_legacy-Test": RemBGSession,
    "ImageRemoveBackground+_legacy-Test": ImageRemoveBackground,

    "RemoveLatentMask+_legacy-Test": RemoveLatentMask,

    #"NoiseFromImage~": NoiseFromImage,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GetImageSize+_legacy-Test": "🔧 Get Image Size_legacy-Test",
    "ImageResize+_legacy-Test": "🔧 Image Resize_legacy-Test",
    "ImageCrop+_legacy-Test": "🔧 Image Crop_legacy-Test",
    "ImageFlip+_legacy-Test": "🔧 Image Flip_legacy-Test",

    "ImageDesaturate+_legacy-Test": "🔧 Image Desaturate_legacy-Test",
    "ImagePosterize+_legacy-Test": "🔧 Image Posterize_legacy-Test",
    "ImageCASharpening+_legacy-Test": "🔧 Image Contrast Adaptive Sharpening_legacy-Test",
    "ImageSeamCarving+_legacy-Test": "🔧 Image Seam Carving_legacy-Test",
    "ImageEnhanceDifference+_legacy-Test": "🔧 Image Enhance Difference_legacy-Test",
    "ImageExpandBatch+_legacy-Test": "🔧 Image Expand Batch_legacy-Test",
    "ImageFromBatch+_legacy-Test": "🔧 Image From Batch_legacy-Test",
    "ImageCompositeFromMaskBatch+_legacy-Test": "🔧 Image Composite From Mask Batch_legacy-Test",
    "ExtractKeyframes+_legacy-Test": "🔧 Extract Keyframes (experimental)_legacy-Test",
    "ImageApplyLUT+_legacy-Test": "🔧 Image Apply LUT_legacy-Test",

    "MaskBlur+_legacy-Test": "🔧 Mask Blur_legacy-Test",
    "MaskFlip+_legacy-Test": "🔧 Mask Flip_legacy-Test",
    "MaskPreview+_legacy-Test": "🔧 Mask Preview_legacy-Test",
    "MaskBatch+_legacy-Test": "🔧 Mask Batch_legacy-Test",
    "MaskExpandBatch+_legacy-Test": "🔧 Mask Expand Batch_legacy-Test",
    "TransitionMask+_legacy-Test": "🔧 Transition Mask_legacy-Test",
    "MaskFromColor+_legacy-Test": "🔧 Mask From Color_legacy-Test",
    "MaskFromBatch+_legacy-Test": "🔧 Mask From Batch_legacy-Test",

    "SimpleMath+_legacy-Test": "🔧 Simple Math_legacy-Test",
    "ConsoleDebug+_legacy-Test": "🔧 Console Debug_legacy-Test",
    "DebugTensorShape+_legacy-Test": "🔧 Tensor Shape Debug_legacy-Test",

    "ModelCompile+_legacy-Test": "🔧 Compile Model_legacy-Test",
    "BatchCount+_legacy-Test": "🔧 Batch Count_legacy-Test",

    "KSamplerVariationsStochastic+_legacy-Test": "🔧 KSampler Stochastic Variations_legacy-Test",
    "KSamplerVariationsWithNoise+_legacy-Test": "🔧 KSampler Variations with Noise Injection_legacy-Test",
    "CLIPTextEncodeSDXL+_legacy-Test": "🔧 SDXLCLIPTextEncode_legacy-Test",
    "SDXLEmptyLatentSizePicker+_legacy-Test": "🔧 SDXL Empty Latent Size Picker_legacy-Test",

    "DrawText+_legacy-Test": "🔧 Draw Text_legacy-Test",
    "RemBGSession+_legacy-Test": "🔧 RemBG Session_legacy-Test",
    "ImageRemoveBackground+_legacy-Test": "🔧 Image Remove Background_legacy-Test",

    "RemoveLatentMask+_legacy-Test": "🔧 Remove Latent Mask_legacy-Test",
